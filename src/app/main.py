...
from src.core.session import ShiftSession
from src.core.session_clock import SessionClock
from src.data.book_cache import BookCache
from src.data.market_data import MarketDataLoop, MarketDataUpdateEvent
...
# Startup wiring (build_runtime, bootstrap_once, create_shift_trader, etc.)
# lives in src.app.bootstrap — this module is the long-lived AppRuntime
# object and its run loop, not the one-shot connect/wire/subscribe sequence.
